const { EmbedBuilder, time, ApplicationCommandOptionType, ApplicationCommandType } = require("discord.js");
...
let topRoles =  user.roles.cache
    ...
    const userBadges = await user.user.flags.toArray();
    ...
    .addFields({ name: '__**User Info:**__', value: `
      ...
      **Created:** ${createdAt}
      **Badges:** ${addBadges(userBadges).join("")}`}) 
